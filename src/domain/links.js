 ...
 *
 * Erkannt werden `[Text](https://…)` und nackte `http(s)://`-Adressen. Mehr nicht: kein
 * Fettdruck, keine Überschriften, keine Listen. Eine Aufgabenverwaltung, die heimlich zum
 * Markdown-Editor wird, kann am Ende beides halb.
 */
...
/** @typedef {{kind: "text", text: string} | {kind: "link", label: string, url: string}} Segment */
